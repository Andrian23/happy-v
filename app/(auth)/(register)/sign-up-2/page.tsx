...
const SignUpSecondPage = () => {
  ...
  return (
    <SignUpLayout currentStep={1}>
      <div className="text-primary-900 text-center text-3xl font-bold">Choose Your Sign-Up Method</div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmitValues)} className="mt-5 w-full">
          <FormField
