      ...
      <div className="mt-5 grid grid-cols-[65%_32%] gap-5">
        <div>
          <div className="mb-5 flex flex-col items-start gap-2.5 self-stretch rounded-[20px] bg-grey-200 p-6">
            <h2 className="text-xl font-bold leading-normal text-primary-900">Client Information</h2>
        ...
        <div className="flex flex-col items-start gap-2.5 self-stretch rounded-[20px] bg-grey-200 p-6">
          <h2 className="text-xl font-bold leading-normal text-primary-900">Discount Option</h2>
          ...
          <h2 className="text-xl font-bold leading-normal text-primary-900">Price</h2>
